...
const PassIconDragAndDrop = props => {
    ...
    const progressIcons = getStageProgress().concat(Array(6 - getStageProgress().length).fill(false)).map((value, key) => (
        <Grid key={key} item>
...
export default DragDropContext(HTML5Backend)(withStyles(styles)(view(PassIconDragAndDrop)));
