...
const Debrief = props => (
    <React.Fragment>
        ...
        <Typography
            ...
            className={props.classes.text}
        >
            You have reached the end of the study. Please enter your age and gender before completing the study.
        </Typography>
        <Typography
            component={"p"}
            className={props.classes.text}
        >
            <TextField
                ...
                value={Number.isInteger(state.result.age) ? state.result.age.toString() : ""}
                onChange={e => parseInt(e.target.value) >= 0 ? state.result.age = parseInt(e.target.value) : ""}
                type="number"
                InputLabelProps={{
                    shrink: true,
                }}
