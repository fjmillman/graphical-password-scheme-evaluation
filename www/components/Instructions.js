    ...
    instructions = (
      <React.Fragment>
        ...
        <Typography component="p" className={classes.text}>
          ...
          objects to be registered. The pass objects form your graphical
          password, the skip objects and the flag objects are defined as
        ...
        <Typography component="p" className={classes.text}>
          ...
          you follow depends on the appearance of the signalling objects on the
          screen. The ordering of stages is randomised. If you pass through each
          stage successfully, you will log in successfully. If you fail one or
          more stages, you will fail to log in.
        </Typography>
      </React.Fragment>
    );
  } else if (scheme === 2) {
    instructions = (
      <React.Fragment>
        ...
        <Typography component="p" className={classes.text}>
          ...
          icons on the screen. Which rule you follow depends on the appearance
          of the signalling objects on the screen. The ordering of stages is
          randomised. If you pass through each stage successfully, you will log
          in successfully. If you fail one or more stages, you will fail to log
          in.
        </Typography>
      </React.Fragment>
    );
